...
- Sep 16 mock post is a shitpost headliner plus per-story take + link (Fugleramme e-ink bird frame, TypeSafe Jev, Mistral x Firefox, Dream-RSI, small programming tricks).
...
## Next actions
1. Review the Sep 16 mock for voice and whether each take stands without the article.
